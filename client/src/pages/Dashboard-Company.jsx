    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="stats-container">
                <div className="stat-box">TOTAL ORDERS <br /><span className="totalorders-company">10</span></div>
                <div className="stat-box">PENDING ORDERS <br /><span className="pendingorders-company">2</span></div>
                <div className="stat-box">COMPLETED ORDERS <br /><span className="completedorders-company">6</span></div>
                <div className="stat-box">ON-PROGRESS <br /><span className="onprogress-company">2</span></div>
            </div>

            <div className="stats-container">
                <div className="payment-box">TOTAL PAYMENTS <br /><span className="totalpayments-company">10</span></div>
                <div className="payment-box">COMPLETED PAYMENTS <br /><span className="completedpayments-company">4</span></div>
                <div className="payment-box">PENDING PAYMENTS <br /><span className="pendingpayments-company">6</span></div>
            </div>
